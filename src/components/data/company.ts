...
export const GALLERY: GalleryImage[] = [
  ...
  {
    id: 'estate-side-view',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592080/Screenshot_2026-08-01_141324_ovh0lf.png',
    alt: 'Estate side view showing the completed housing development from the side',
    caption: 'Estate side view',
  },
  {
    id: 'estate-front-view',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592084/Screenshot_2026-08-01_141826_btvnvk.png',
    alt: 'Estate front view with the main frontage and access roads',
    caption: 'Estate front view',
  },
  {
    id: 'living-apartment',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592087/Screenshot_2026-08-01_142700_gajfyv.png',
    alt: 'Living apartment interior with a modern lounge and dining area',
    caption: 'Living apartment',
  },
  {
    id: 'penthouse-outer-1',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592094/Screenshot_2026-08-01_142854_ybfddk.png',
    alt: 'Penthouse exterior with a striking facade and surrounding landscape',
    caption: 'Penthouse outer view',
  },
  {
    id: 'penthouse-outer-2',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592111/Screenshot_2026-08-01_142454_lmgoks.png',
    alt: 'Penthouse exterior view from a second angle',
    caption: 'Penthouse outer view',
  },
  {
    id: 'building-plan',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592122/Screenshot_2026-08-01_143240_dmxj19.png',
    alt: 'Building plan and architectural layout for the development',
    caption: 'Building plan',
  },
  {
    id: 'dump-truck',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592126/Screenshot_2026-08-01_144006_u7qs9s.png',
    alt: 'Heavy-duty dump truck used on a construction site',
    caption: 'Dump truck',
  },
  {
    id: 'penthouse-1',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592135/Screenshot_2026-08-01_143202_iedd7j.png',
    alt: 'Penthouse residence with a polished modern facade',
    caption: 'Penthouse',
  },
  {
    id: 'penthouse-2',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592135/Screenshot_2026-08-01_142741_pmi6ma.png',
    alt: 'Penthouse unit from another perspective',
    caption: 'Penthouse',
  },
  {
    id: 'solar-installation',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785593591/Screenshot_2026-08-01_144308_tjrsmn.png',
    alt: 'Solar installation mounted on a rooftop system',
    caption: 'Solar installation',
  },
  {
    id: 'construction-works',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592143/Screenshot_2026-08-01_143932_kyl3xt.png',
    alt: 'Construction works in progress on a project site',
    caption: 'Construction works',
  },
  {
    id: 'industrial-farm-work',
    src: 'https://res.cloudinary.com/derzcse6f/image/upload/v1785592136/Screenshot_2026-08-01_144048_dxni3f.png',
    alt: 'Industrial farm work in progress',
    caption: 'Industrial farm work',
  },
];
